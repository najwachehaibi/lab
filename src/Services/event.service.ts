...
export class EventService {
  ...
  affecter(idevent:any,idmembre: any): Promise<void> {
    return this.httpClient.get<void>('http://localhost:9000/MEMBRE-SERVICE/affecterauteurToEvent/' + idevent +'/' +idmembre).toPromise();
