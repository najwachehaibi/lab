...
export class OutilService {
  ...
  affecter(idOutil:any,idmembre: any): Promise<void> {
    return this.httpClient.get<void>('http://localhost:9000/MEMBRE-SERVICE/affecterauteurToOutil/' + idOutil +'/' +idmembre).toPromise();
